 ...
 */
class Card extends \Civix\CoreBundle\Entity\Customer\Card implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'name', 'balancedUri', 'updatedAt', 'createdAt', 'number', 'customer');
    }
