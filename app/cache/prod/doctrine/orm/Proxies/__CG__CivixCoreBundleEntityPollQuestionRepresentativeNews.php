 ...
 */
class RepresentativeNews extends \Civix\CoreBundle\Entity\Poll\Question\RepresentativeNews implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setSubjectParsed($subjectParsed);
    }

    public function getSubjectParsed()
    {
        $this->__load();
        return parent::getSubjectParsed();
    }
    ...
    public function isSubjectValid(\Symfony\Component\Validator\ExecutionContextInterface $context)
    {
        $this->__load();
        return parent::isSubjectValid($context);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'subject', 'createdAt', 'updatedAt', 'expireAt', 'publishedAt', 'reportRecipientGroup', 'answersCount', 'cachedHashTags', 'options', 'answers', 'educationalContext', 'comments', 'reportRecipient', 'recipients', 'hashTags', 'groupSections', 'subjectParsed', 'user');
    }
