 ...
 */
class MicroPetition extends \Civix\CoreBundle\Entity\Activities\MicroPetition implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setPetitionId($id);
    }
    ...
    {
        $this->__load();
        return parent::setQuorum($quorum);
    }

    public function getQuorum()
    {
        $this->__load();
        return parent::getQuorum();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'title', 'description', 'sentAt', 'expireAt', 'responsesCount', 'owner', 'isOutsiders', 'rateUp', 'rateDown', 'imageSrc', 'representative', 'group', 'superuser', 'user', 'activityConditions', 'petitionId', 'quorum');
    }
