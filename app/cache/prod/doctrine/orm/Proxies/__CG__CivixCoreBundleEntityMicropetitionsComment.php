 ...
 */
class Comment extends \Civix\CoreBundle\Entity\Micropetitions\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'commentBody', 'commentBodyHtml', 'createdAt', 'rateSum', 'ratesCount', 'privacy', 'parentComment', 'childrenComments', 'user', 'rates', 'petition');
    }
