 ...
 */
class QuestionLimit extends \Civix\CoreBundle\Entity\QuestionLimit implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setQuestionLimit($limitValue);
    }
    ...
    {
        return array('__isInitialized__', 'id', 'questionType', 'questionLimit');
    }
