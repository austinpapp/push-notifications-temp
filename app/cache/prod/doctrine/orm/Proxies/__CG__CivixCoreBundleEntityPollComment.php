 ...
 */
class Comment extends \Civix\CoreBundle\Entity\Poll\Comment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        return array('__isInitialized__', 'id', 'commentBody', 'commentBodyHtml', 'createdAt', 'rateSum', 'ratesCount', 'privacy', 'parentComment', 'childrenComments', 'user', 'rates', 'question');
    }
