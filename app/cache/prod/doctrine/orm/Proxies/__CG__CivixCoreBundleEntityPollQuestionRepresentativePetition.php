 ...
 */
class RepresentativePetition extends \Civix\CoreBundle\Entity\Poll\Question\RepresentativePetition implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    {
        $this->__load();
        return parent::setPetitionTitle($petitionTitle);
    }

    public function getPetitionTitle()
    {
        $this->__load();
        return parent::getPetitionTitle();
    }
    ...
    {
        return array('__isInitialized__', 'id', 'subject', 'createdAt', 'updatedAt', 'expireAt', 'publishedAt', 'reportRecipientGroup', 'answersCount', 'cachedHashTags', 'options', 'answers', 'educationalContext', 'comments', 'reportRecipient', 'recipients', 'hashTags', 'groupSections', 'isOutsidersSign', 'petitionTitle', 'petitionBody', 'user');
    }
